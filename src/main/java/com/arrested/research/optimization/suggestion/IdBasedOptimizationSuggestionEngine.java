...
class IdBasedOptimizationSuggestionEngine implements SuggestionEngine {
	...
	static final String REWRITE_SELECTOR_WITH_ID_FIRST = "Beginning selectors with an id has the best performance.  Consider re-writing this selector to begin with an id to reduce the size of the DOM to be searched.";
	static final String SELECTOR_AND_CHILD_TEMPLATE = "Consider re-writing this selector as $('%s').find('%s') to improve selector performance.";
